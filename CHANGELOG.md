...
### Changed
- Complete code refactor to comply with several Sonarqube reports (Security hotspots, maintainability and reliability). Aimes to be 100% passing
- MISSES Code Test Coverages, to be added
